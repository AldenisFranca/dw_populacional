-- query create table with countries, regions and continents

CREATE TABLE countries_regions_continents (id_geo SERIAL, country VARCHAR(255),continent VARCHAR(255),region VARCHAR(255));

INSERT INTO countries_regions_continents (country,continent,region) VALUES 
 ('Afghanistan','Asia','Southern Asia'), 
 ('Iland Islands','Europe','Northern Europe'), 
 ...
 ('Bonaire, Sint Eustatius and Saba','Americas','Caribbean'), 
 ...
 ('Congo (Democratic Republic of the)','Africa','Middle Africa'), 
 ...
 ('Falkland Islands (Malvinas)','Americas','South America'), 
 ...
 ('Macedonia (the former Yugoslav Republic of)','Europe','Southern Europe'), 
 ...
 ('Saint Pierre and Miquelon','Americas','Northern America'), 
 ...
 ('Taiwan, Province of China','Asia','Eastern Asia'), 
